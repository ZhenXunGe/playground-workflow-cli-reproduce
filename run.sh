...
test_continuation_cli() {
    ...
    $ZKWASM_CLI --params $PARAMSDIR image dry-run --wasm $IMAGEDIR/image.wasm --public 25:i64 --public 24:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --output ./output
    CUDA_VISIBLE_DEVICES=0 $ZKWASM_CLI --params $PARAMSDIR image prove --public 25:i64 --public 24:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --public 0:i64 --padding 3 --wasm $IMAGEDIR/image.wasm --output $OUTPUTDIR
